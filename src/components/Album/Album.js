...
const Album = () => {
  ...
  // Fetching Albums from API as given example
  useEffect(() => {
  ...
  // Edit albume and update the new title
      ...
      <section className="py-2 text-center container">
        <div className="row py-lg-2">
          <div className="col-lg-6 col-md-8 mx-auto">
            <h1 className="fw-bold text-light">Album Gallary</h1>
            <p className="lead text-light">
              Photo album collections allow users to store their
              photos into albums.
            </p>
